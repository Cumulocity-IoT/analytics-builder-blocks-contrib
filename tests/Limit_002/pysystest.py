__pysys_title__   = r""" Limit block - both limits, value below lower. """
#                        =========================================================================
__pysys_purpose__ = r""" Limit block - both limits, value below lower. """
...
class PySysTest(AnalyticsBuilderBaseTest):
    ...
    def validate(self):
        ...
        # Verify output: value below lower limit should be clamped to lower limit
        self.assertBlockOutput('limited', [10.0])
