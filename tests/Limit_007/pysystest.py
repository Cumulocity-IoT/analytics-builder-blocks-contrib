__pysys_title__   = r""" Limit block - only upper limit, value above. """
#                        =========================================================================
__pysys_purpose__ = r""" Limit block - only upper limit, value above. """
...
class PySysTest(AnalyticsBuilderBaseTest):
    ...
    def validate(self):
        ...
        # Verify output: with only upper limit, value above limit is clamped to upper
        self.assertBlockOutput('output', [100.0])
