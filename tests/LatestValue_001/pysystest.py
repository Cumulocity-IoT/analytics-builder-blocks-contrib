...
__pysys_title__   = r""" Latest Value test """
#                        ================================================================================
__pysys_purpose__ = r""" Latest Value test """
...
class PySysTest(AnalyticsBuilderBaseTest):
	...
	def validate(self):
		...
		self.assertGrep("waiter.out", expr=re.escape('apamax.analyticsbuilder.test.Output("latest","model_0","apama.analyticsbuilder.Partition_Default()",-.1,any(float,12),{})'))
