...
#                        ================================================================================
__pysys_purpose__ = r""" Test Tenatoptions are handled""" 
...
class PySysTest(AnalyticsBuilderBaseTest):
	...
	def execute(self):
		...
		correlator.injectEPL("TenantOptionsSim.mon")
		...
		self.modelId = self.createTestModel('apamax.analyticsbuilder.custom.HTTPOutput',{'method':'GET', 
																				   'credentialsFromTenantOptions': 'true',
																				   'auth_type': 'Basic Auth',
																				   'username_apiKey': 'msoption/userkey',
																				   'password_apiValue': 'msoption/uservalue',
