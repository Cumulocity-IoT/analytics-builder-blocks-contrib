__pysys_title__   = r""" MathOperation block - Division test. """
#                        =========================================================================
__pysys_purpose__ = r""" MathOperation block - Division test with non-zero divisor. """
...
class PySysTest(AnalyticsBuilderBaseTest):
	def execute(self):
		...
		# Deploying a new model with division operation.
		self.modelId = self.createTestModel('apamax.analyticsbuilder.blocks.MathOperation',
											{'operation': 'division'})
		self.sendEventStrings(correlator,
							  self.timestamp(1),
							  self.inputEvent('value1', 30.0, id=self.modelId),
	...
	def validate(self):
		...
		# Verify the output is the quotient: 30.0 / 5.0 = 6.0
		self.assertBlockOutput('output', [6.0])
