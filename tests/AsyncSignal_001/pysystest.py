...
#
__pysys_title__   = r""" Async Send Signal block - test. """
#                        ================================================================================
...
class PySysTest(AnalyticsBuilderBaseTest):
	...
	def validate(self):
		...
		self.assertGrep("waiter.out", expr=re.escape('apamax.analyticsbuilder.blocks.AsyncSignal("Reset","model_0",any(apama.analyticsbuilder.Partition_Default,apama.analyticsbuilder.Partition_Default()),{})'))
		self.assertGrep("waiter.out", expr=re.escape('apamax.analyticsbuilder.blocks.AsyncSignal("Reset","model_0",any(apama.analyticsbuilder.Partition_Default,apama.analyticsbuilder.Partition_Default()),{"a":any(float,100)})'))
