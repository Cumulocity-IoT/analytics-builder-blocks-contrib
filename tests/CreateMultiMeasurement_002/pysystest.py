__pysys_title__   = r""" Create multi-measurement - test value and unit. """
#                        ================================================================================
__pysys_purpose__ = r""" Create multi-measurement - test value and unit. """
...
class PySysTest(AnalyticsBuilderBaseTest):
	...
	def execute(self):
		...
		self.sendEventStrings(correlator,
		                      ...
		                      self.inputEvent('value', True, id = self.modelId, 
										properties={'c8y_Acceleration.x':{'value':1.0,'unit':'m/s2'},'c8y_Acceleration.y':{'value':0.0,'unit':'m/s2'},'c8y_Acceleration.z':{'value':3.0,'unit':'m/s2'}}),
		                      self.timestamp(2)
							  )
	...
	def validate(self):
		...
		self.assertGrep("waiter.out", expr=re.escape('com.apama.cumulocity.Measurement("","c8y_Acceleration","d123",1,{"c8y_Acceleration":{"x":com.apama.cumulocity.MeasurementValue(1,"m/s2",{}),"y":com.apama.cumulocity.MeasurementValue(0,"m/s2",{}),"z":com.apama.cumulocity.MeasurementValue(3,"m/s2",{})}},{"apama_analytics_modelName":any(string,"model_0")})'))
