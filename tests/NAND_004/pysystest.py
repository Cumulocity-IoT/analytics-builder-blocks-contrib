...
#
__pysys_title__   = r""" NAND block - touch test. """
#                        ================================================================================
__pysys_purpose__ = r""" NAND block - touch test. """
...
class PySysTest(AnalyticsBuilderBaseTest):
	...
	def validate(self):
		...
		self.assertGrep(self.analyticsBuilderCorrelator.logfile, expr='nandOutput = false')
