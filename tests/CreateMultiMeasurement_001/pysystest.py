__pysys_title__   = r""" Create multi-measurement - test value only. """
#                        ================================================================================
__pysys_purpose__ = r""" Create multi-measurement - test value only. """
...
class PySysTest(AnalyticsBuilderBaseTest):
	...
	def validate(self):
		...
		self.assertGrep("waiter.out", expr=re.escape('com.apama.cumulocity.Measurement("","c8y_Acceleration","d123",1,{"c8y_Acceleration":{"x":com.apama.cumulocity.MeasurementValue(1,"",{}),"y":com.apama.cumulocity.MeasurementValue(0,"",{}),"z":com.apama.cumulocity.MeasurementValue(2,"",{})}},{"apama_analytics_modelName":any(string,"model_0")})'))
