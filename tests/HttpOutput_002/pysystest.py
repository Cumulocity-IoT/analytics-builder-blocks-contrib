__pysys_title__   = r""" Http Output Tests for POST """ 
#                        ================================================================================
__pysys_purpose__ = r""" Test calling POST for create items via HTTP""" 
...
class PySysTest(AnalyticsBuilderBaseTest):
	...
	def execute(self):
		...
		self.modelId = self.createTestModel('apamax.analyticsbuilder.custom.HTTPOutput',{'method':'POST', 
																				   'auth_type': 'No Auth',
		...
		self.waitForSignal('test-http-server.out', expr='Received POST request')
	...
	def validate(self):
		self.assertBlockOutput('statusCode', [201.0])
